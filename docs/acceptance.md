...
- **Result:** partial — PIR pass (STUDY EXAMPLE PIR, FF HALLWAY PIR, GF HALLWAY PIR; on→off within ~2–6s). Door / window / other / shock not walked tonight.
...
- 🚀 Booted via `/run` (Supervisor + HA); installed local Mosquitto; configured Texecom Alarm to the live panel (`192.0.2.10:10001`, UDL `1234`) and local MQTT.
