...
High — acceptance/run/cold-start personal zones + `192.168.1.183`/`1234`; spikes 002/005/006/007; protocol-reference / architecture / analysis RISK-009 "this panel still uses factory UDL"; spec-zone-monitoring Ethan example; household-ops detail in alarm/zone specs.
