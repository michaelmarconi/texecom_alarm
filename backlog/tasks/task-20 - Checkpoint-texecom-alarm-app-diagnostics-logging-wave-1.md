...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 texecom-alarm-app tests pass (pytest exits 0)
- [x] #2 log_level schema tokens are WARNING|INFO|DEBUG|TRACE and default INFO is covered by tests
- [x] #3 DEBUG/TRACE/modem-skip integration coverage from TASK-19 is green
<!-- AC:END -->
...
## Definition of Done
<!-- DOD:BEGIN -->
- [x] #1 spec-diagnostics-logging AC1–AC6 satisfied by TASK-18/19
- [x] #2 AC7 (live TRACE hunt correlating a real zone event to add-on logs) remains manual acceptance — exercise when convenient after merge
- [x] #3 docs/plan.md scope map notes diagnostics-logging wave
<!-- DOD:END -->
